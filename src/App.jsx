    ...
    <div className="app">
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">Aishu</span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">Aishu's</span>{" "}
                special day 🎂
              </>
            )}
          </h1>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">💖 It'll always be you 💖</h2>
        </section>
      </div>
